...
@section('statistics')
    <div class="stats-container">
        <div class="container">
            ...
            <div class="col-lg-12">
                <h1 class="text-center">Sati volontiranja prema</h1>
                ...
                <div class="col-lg-4">
                    <div class="col-md-12 search-bar" id="statsSearch">
                        <form class="searchbox-min" action="">
                            <input type="search" placeholder="Pretraži po satima" id="searchBox"/>
                        </form>
                    </div>
        ...
        @section('scripts')
            ...
            <script>
                ...
                $('#stats-city').click(function () {
                    ...
                    emptyPrevious('')
                    getStats(new Date().getFullYear() - 1, '/stats/stats-working-hours-city/', 'empty')
                });
                $('#stats-county').click(function () {
                    ...
                    $(this).addClass("change-category-active")
                    emptyPrevious('')
                    getStats(new Date().getFullYear() - 1, '/stats/stats-working-hours-county/', 'empty')
                ...
                $('#stats-region').click(function () {
                    ...
                    $(this).addClass("change-category-active")
                    emptyPrevious('')
                    getStats(new Date().getFullYear() - 1, '/stats/stats-working-hours-region/', 'empty')
                });
            </script>
