...
@section('content')
    ...
    <div class="container">
        ...
        <div class="col-lg-12">
            <h1 class="text-center">Volunteering hours stats by geolocation</h1>
...
@section('scripts')
    ...
    <script>
        $('#stats-city').click(function () {
            emptyPrevious('Number of volunteering hours by city')
            var city_url = '/stats/stats-working-hours-city/'
            getStats(city_url)
        });


        $('#stats-county').click(function () {
            emptyPrevious('Number of volunteering hours by county')
            var counties_url = '/stats/stats-working-hours-county/'
            getStats(counties_url)

        });

        $('#stats-region').click(function () {
            emptyPrevious('Number of volunteering hours by region')
            var regions_url = '/stats/stats-working-hours-region/';
