...
class AdminImagesController extends \Zantolov\Zamb\Controller\AdminCRUDController
{
    ...
    protected function afterConstruct()
    {
        ...
        $this->templateRoot = 'Admin.Images';
    ...
    {
        $items = DB::table('images')->select(array(
            'images.id',
            'images.id as filename',
            'images.title',
            'images.created_at'
        ));
    ...
    public function postStore()
    {
        ...
        $rules = array(
            'file' => 'required|mimes:jpeg,jpg,png,bmp,gif,svg,octet-stream|max:4096',
        );
    ...
    public function getPopup()
    {
        ...
        return $this->render('Admin.Images.popup', compact('images'));
    }
