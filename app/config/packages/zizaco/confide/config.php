...
return array(
    ...
    */
    ...
    |
    */
    'login_form' =>             'Security.login',
    'signup_form' =>            'Security.signup',
    'forgot_password_form' =>   'Security.forgot_password',
    'reset_password_form' =>    'Security.reset_password',
    ...
    |
    */
    'email_reset_password' =>       'Security.emails.passwordreset', // with $user and $token.
    'email_account_confirmation' => 'Security.emails.confirm', // with $user
